...
export const UserSettingsForm = () => {
  ...
  // State to keep track of required water dynamically
  ...
  // Use effect to update requiredWater whenever relevant fields change
  useEffect(() => {
    setRequiredWater(calcRequiredWater(user.gender, user.weight, user.sportTime));
  ...
  // Handle input change to dynamically update requiredWater
  const handleInputChange = (e, setFieldValue) => {
    ...
    if (name === "gender" || name === "weight" || name === "activityTime") {
      ...
      const newRequiredWater = calcRequiredWater(newGender, newWeight, newActivityTime);
      setRequiredWater(newRequiredWater);
    }
  };
...
css.numberInput, errors.weight && css.error)}
                    name="weight"
                    id={weightId}
                    type="number"
                    min="0"
...
onChange={(e) => handleInputChange(e, setFieldValue)}
                  ...
                  <ErrorMessage
                    ...
                    component="span"
                  />
                  {/* <span className={css.literPosition}>l</span> */}
                </div>
              </div>
            </div>
          </div>
